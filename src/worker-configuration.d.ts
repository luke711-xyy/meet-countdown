/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: c193513bd5d680c990010eae3d5daf07)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	COUPLE_ROOM: DurableObjectNamespace<import("./worker").CoupleRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "CoupleRoom";
	}
